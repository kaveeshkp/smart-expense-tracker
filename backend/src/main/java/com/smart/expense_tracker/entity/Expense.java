...
public class Expense {
    ...
    public Expense(Long id, User user, Category category, String title, BigDecimal amount, LocalDate date, String notes, Boolean aiCategorized, LocalDateTime createdAt) {
        this.id = id;
        this.user = user;
